/*Escreva uma função que retorne a média de todos os valores 
de uma matriz declarada da seguinte forma:
...
Ter outros nos outros dois parâmetros o número de linhas e 
o número de colunas que serão considerados;
